...
<html lang="en" dir="ltr">
  <head>
    ...
    <script src="js/manage_medicine_stock2.js"></script>
    ...
    <div class="container-fluid" style="width:82%; margin-left:18%">
      <div class="container">
        ...
        <?php
          ...
          createHeader('toolbox', 'Manage Product Stock', '<i class="fa fa-tools"></i> &nbsp;Manage Stock');
        ?>
        <!-- header section end -->
        ...
        <div class="row" style="margin-top:45px">
          ...
          <div class="col-md-12 form-group form-inline">
            ...
            &emsp;<input type="text" class="form-control" id="by_sell_price" placeholder="By Selling price" onkeyup="searchMedicineStock(this.value, 'MRP');">
            ...
            <br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button style="margin-left:8.5%" class="btn btn-warning font-weight-bold" onclick="searchMedicineStock('', 'EXPIRY_DATE');">Expired</button>
