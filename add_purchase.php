...
<html lang="en" dir="ltr">
  <head>
    ...
    <script type="text/javascript" src="js/add_new_purchase11.js"></script>
    ...
    <div class="container-fluid" style="width:82%; margin-left:18%">
      <div class="container">
        ...
        <?php
          ...
          createHeader('shopping-cart', 'Purchase', '<i class="fa fa-plus-circle"></i> &nbsp;Add New Purchase');
        ?>
        <!-- header section end -->
        ...
        <div class="row" style="margin-top:45px">
          ...
          <div class="row col col-md-12">
            ...
            <div class="col col-md-2 form-group">
              <label class="font-weight-bold" for="">Invoice No:</label>
          ...
          <div class="row col col-md-12 font-weight-bold">
            ...
            <div class="col col-md-1">Buy.P</div>
          ...
          <div class="row col col-md-12">
            ...
            <div class="col col-md-2 form-group">
              <button class="btn btn-primary set form-control" onclick="addPurchase();"><i class="fa fa-circle-plus"></i> &nbsp;ADD</button>
            </div>
            <div class="col col-md-5"></div>
          </div>
          <!-- closing button -->
