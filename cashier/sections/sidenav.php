  ...
  <div class="card">
    <div class="card-body">
      <div class="logo">
        ...
        <h1 class="logo-caption text-strong"><span style="color:rgb(103,243,108); font-weight: bolder;">C</span>ashier</h1>
        
      </div> <!-- logo class -->
      <!-- dashboard start -->
      
      <div class="main-menu-item"  <?php  makeActive(0) ?>>
        <a href="home.php?menu=0"><i class="fa fa-dashboard" style="color:rgb(103,243,108)"></i><span>Dashboard
      ...
      <div id="first" class="main-menu-item" onclick="showhide(this.id);" <?php  makeActive(1) ?>>
      	<a  href="#">
      		<i class="fa fa-balance-scale" style="color:rgb(103,243,108)"></i><span>Invoice</span>
      ...
      <div id="second" class="main-menu-item" onclick="showhide(this.id);"<?php makeActive(2) ?>>
      	<a>
      		<i class="fa fa-hand-holding-medical" style="color:rgb(103,243,108)"></i><span>Customer</span>
      		<span class="pull-right-container">
      ...
      <div id="fifth" class="main-menu-item" onclick="showhide(this.id);" <?php  makeActive(5) ?>>
      	<a href="#?menu=5">
      		<i class="fa fa-coins" style="color:rgb(103,243,108)"></i><span>Sales Report</span>
      		<span class="pull-right-container">
      			<i class="fa fa-angle-down pull-right" style="margin-left:25.5% ;position:absolute; margin-top:5px"></i>
      		</span>
      	</a>
      	<ul class="treeview-menu" style="display: none;">
      		<li class="treeview"><a href="daySales.php?menu=5"><i class="fa fa-check-circle"></i>&nbsp;&nbsp;Todays Sales</a></li>
      		<li class="treeview"><a href="specific_reports.php?menu=5"><i class="fa fa-check-circle"></i>&nbsp;&nbsp;Other Sales</a></li>
      	</ul>
      </div>
      ...
      <div id="seventh" class="main-menu-item" onclick="showhide(this.id);" <?php makeActive(7) ?>>
      	<a href="#">
      		<i class="fa fa-search" style="color:rgb(103,243,108)"></i><span>Search</span>
      		<span class="pull-right-container">
      		<i class="fa fa-angle-down pull-right" style="margin-left:41.5%;position:absolute; margin-top:5px"></i>
      		</span>
      	</a>
      	<ul class="treeview-menu" style="display: none;">
