        ...
        <div class="row" style="margin-top:45px">
          ...
          <div class="row col col-md-12">
            <div class="row col col-md-12 font-weight-bold">
              ...
              <div class="col col-md-2 text-right">Total</div>
          ...
          <div class="row col col-md-12">
            <div id="save_button" class="col col-md-2 form-group float-right">
              ...
              <button class="btn btn-success  form-control font-weight-bold" onclick="addInvoice(); pull-left"><i class="fa fa-save "></i>&nbsp;Save</button>
            </div>
