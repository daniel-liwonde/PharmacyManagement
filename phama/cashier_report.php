      ...
      <div class="container">
        ...
        <div class="row" style="margin-top:45px">
          <div class="col-md-12 form-group form-inline">
            ...
            &nbsp;From:&nbsp;
             <input type="text" class="datepicker form-control" id="start_date" onchange="showReport('Cashier');" >
            &nbsp;
             &nbsp;To:&nbsp;
            <input type="text" class="datepicker form-control" id="end_date" onchange="showReport('Cashier');">
            &nbsp;
