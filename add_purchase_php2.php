    ...
    <div class="container-fluid" style="width:82%; margin-left:18%">
      <div class="container">
        ...
        <?php
          ...
          createHeader('bar-chart', 'Purchase', '<i class="fas fa-plus"></i> &nbsp;Add New Purchase');
        ?>
        <!-- header section end -->
        ...
        <div class="row" style="margin-top:45px">
          ...
          <div class="row col col-md-12">
            ...
            <div class="col col-md-2 form-group">
              <button class="btn btn-primary form-control" onclick="addPurchase();"><i class="fa fa-circle-plus"></i> &nbsp;ADD</button>
            </div>
            <div class="col col-md-5"></div>
          </div>
          <!-- closing button -->
