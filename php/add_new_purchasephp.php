...
function checkIfItemExpires($name){
require "db_connection.php";
    if($con) {
      $query = "SELECT EXPIRY_DATE FROM medicines_stock WHERE UPPER(NAME) = '$name'";
      $result = mysqli_query($con, $query);
      $row = mysqli_fetch_array($result);
      echo ($row) ? "true" : "false";
    }
     ...
     require "db_connection.php";
      ...
      <div class="row col col-md-12">
        <div class="col col-md-2">
          <select  class="form-control" placeholder="Medicine Name" name="medicine_name">
