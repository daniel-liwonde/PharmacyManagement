...
function showPurchaseDetails($invoice_number) {
    ...
    <div class="row">
     ...
     $cashier_fname =  $row_facilitator['FNAME'];
      ...
      <div class="col-md-4">
        <span class="h4">Purchase facilitated by: </span><br><br>
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 mb-2" > <a style="margin-left:8.6%" class="btn btn-info " href="purchase_report.php?menu=6">Back</a></div>
    </div>
